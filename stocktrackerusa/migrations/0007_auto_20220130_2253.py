# Generated by Django 3.1.3 on 2022-01-30 13:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stocktrackerusa', '0006_auto_20220130_1508'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('StockBarcode_ID', models.CharField(default='', max_length=150, primary_key=True, serialize=False)),
                ('ListedStockInfo', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='stocktrackerusa.listedstockinfo')),
                ('StockBarcodePerfReturn', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='stocktrackerusa.stockbarcodeperfreturn')),
                ('StockBarcodePerfTotal', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='stocktrackerusa.stockbarcodeperftotal')),
            ],
        ),
        migrations.CreateModel(
            name='QuestionCount',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip', models.CharField(max_length=30)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stocktrackerusa.question')),
            ],
        ),
    ]
