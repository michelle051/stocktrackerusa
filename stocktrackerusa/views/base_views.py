...
def index(request):
    ...
    context = {'pathdetailinfo_list': pathdetailinfo_list, 'kw': kw, 'totalvisitcnt': totalvisitcnt,
...
def qna(request):
    ...
    context = {'question_list': page_obj, 'page': page, 'kw': kw, 'totalvisitcnt': totalvisitcnt,
               'todayvisitcnt': todayvisitcnt}
